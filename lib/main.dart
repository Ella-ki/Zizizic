...
import 'package:zizizic/mainPage.dart';
...
void main() async {
  ...
  await Firebase.initializeApp(
      options: const FirebaseOptions(
        apiKey: 'AIzaSyARDTxBeF9RlM-dHNZPVmG1H_VthvYEglY',
        appId: '',
        messagingSenderId: '848352881117',
        projectId: 'zizizic-8e678',
        databaseURL: 'https://zizizic-8e678-default-rtdb.firebaseio.com',
      )
  );
